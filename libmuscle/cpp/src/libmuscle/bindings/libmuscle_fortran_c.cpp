...
void LIBMUSCLE_Instance_get_setting_as_int8array_(std::intptr_t self, char * name, std::size_t name_size, std::int64_t ** value, std::size_t * value_size, int * err_code, char ** err_msg, std::size_t * err_msg_len) {
    Instance * self_p = reinterpret_cast<Instance *>(self);
    std::string name_s(name, name_size);
    try {
        *err_code = 0;
