...
void LIBMUSCLE_MPI_DataConstRef_describe_(std::intptr_t self, char ** ret_val, std::size_t * ret_val_size) {
    DataConstRef * self_p = reinterpret_cast<DataConstRef *>(self);
...
void LIBMUSCLE_MPI_Data_describe_(std::intptr_t self, char ** ret_val, std::size_t * ret_val_size) {
    Data * self_p = reinterpret_cast<Data *>(self);
    static std::string result;
    result = self_p->describe();
    *ret_val = const_cast<char*>(result.c_str());
