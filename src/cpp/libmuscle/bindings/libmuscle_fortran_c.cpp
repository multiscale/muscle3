...
bool LIBMUSCLE_Instance_is_setting_a_int8array_(std::intptr_t self, char * name, std::size_t name_size, int * err_code, char ** err_msg, std::size_t * err_msg_len) {
    Instance * self_p = reinterpret_cast<Instance *>(self);
    std::string name_s(name, name_size);
    try {
        *err_code = 0;
...
void LIBMUSCLE_Instance_get_setting_as1_character_(std::intptr_t self, char * name, std::size_t name_size, char ** ret_val, std::size_t * ret_val_size, int * err_code, char ** err_msg, std::size_t * err_msg_len) {
    Instance * self_p = reinterpret_cast<Instance *>(self);
    std::string name_s(name, name_size);
    try {
        *err_code = 0;
...
int64_t LIBMUSCLE_Instance_get_setting_as1_int8_(std::intptr_t self, char * name, std::size_t name_size, int * err_code, char ** err_msg, std::size_t * err_msg_len) {
    Instance * self_p = reinterpret_cast<Instance *>(self);
    std::string name_s(name, name_size);
    try {
        *err_code = 0;
...
double LIBMUSCLE_Instance_get_setting_as1_real8_(std::intptr_t self, char * name, std::size_t name_size, int * err_code, char ** err_msg, std::size_t * err_msg_len) {
    Instance * self_p = reinterpret_cast<Instance *>(self);
    std::string name_s(name, name_size);
    try {
        *err_code = 0;
...
bool LIBMUSCLE_Instance_get_setting_as1_logical_(std::intptr_t self, char * name, std::size_t name_size, int * err_code, char ** err_msg, std::size_t * err_msg_len) {
    Instance * self_p = reinterpret_cast<Instance *>(self);
    std::string name_s(name, name_size);
    try {
        *err_code = 0;
...
void LIBMUSCLE_Instance_get_setting_as1_int8array_(std::intptr_t self, char * name, std::size_t name_size, std::int64_t ** value, std::size_t * value_size, int * err_code, char ** err_msg, std::size_t * err_msg_len) {
    Instance * self_p = reinterpret_cast<Instance *>(self);
    std::string name_s(name, name_size);
    try {
        *err_code = 0;
...
void LIBMUSCLE_Instance_get_setting_as1_real8array_(std::intptr_t self, char * name, std::size_t name_size, double ** value, std::size_t * value_size, int * err_code, char ** err_msg, std::size_t * err_msg_len) {
    Instance * self_p = reinterpret_cast<Instance *>(self);
    std::string name_s(name, name_size);
    try {
        *err_code = 0;
...
void LIBMUSCLE_Instance_get_setting_as1_real8array2_(std::intptr_t self, char * name, std::size_t name_size, double ** value, std::size_t * value_shape, int * err_code, char ** err_msg, std::size_t * err_msg_len) {
    Instance * self_p = reinterpret_cast<Instance *>(self);
    std::string name_s(name, name_size);
    try {
        *err_code = 0;
...
void LIBMUSCLE_Instance_get_setting_as2_character_(std::intptr_t self, char * name, std::size_t name_size, char * default_value, std::size_t default_value_size, char ** ret_val, std::size_t * ret_val_size, int * err_code, char ** err_msg, std::size_t * err_msg_len) {
    Instance * self_p = reinterpret_cast<Instance *>(self);
    std::string name_s(name, name_size);
...
int64_t LIBMUSCLE_Instance_get_setting_as2_int8_(std::intptr_t self, char * name, std::size_t name_size, int64_t default_value, int * err_code, char ** err_msg, std::size_t * err_msg_len) {
    Instance * self_p = reinterpret_cast<Instance *>(self);
    std::string name_s(name, name_size);
    try {
        *err_code = 0;
...
double LIBMUSCLE_Instance_get_setting_as2_real8_(std::intptr_t self, char * name, std::size_t name_size, double default_value, int * err_code, char ** err_msg, std::size_t * err_msg_len) {
    Instance * self_p = reinterpret_cast<Instance *>(self);
    std::string name_s(name, name_size);
    try {
        *err_code = 0;
...
bool LIBMUSCLE_Instance_get_setting_as2_logical_(std::intptr_t self, char * name, std::size_t name_size, bool default_value, int * err_code, char ** err_msg, std::size_t * err_msg_len) {
    Instance * self_p = reinterpret_cast<Instance *>(self);
    std::string name_s(name, name_size);
    try {
        *err_code = 0;
...
void LIBMUSCLE_Instance_get_setting_as2_int8array_(std::intptr_t self, char * name, std::size_t name_size, std::int64_t * default_value, std::int64_t default_value_size, std::int64_t ** value, std::size_t * value_size, int * err_code, char ** err_msg, std::size_t * err_msg_len) {
    Instance * self_p = reinterpret_cast<Instance *>(self);
    std::string name_s(name, name_size);
...
void LIBMUSCLE_Instance_get_setting_as2_real8array_(std::intptr_t self, char * name, std::size_t name_size, double * default_value, std::size_t default_value_size, double ** value, std::size_t * value_size, int * err_code, char ** err_msg, std::size_t * err_msg_len) {
    Instance * self_p = reinterpret_cast<Instance *>(self);
    std::string name_s(name, name_size);
...
void LIBMUSCLE_Instance_get_setting_as2_real8array2_(std::intptr_t self, char * name, std::size_t name_size, double * default_value, std::size_t * default_value_shape, double ** value, std::size_t * value_shape, int * err_code, char ** err_msg, std::size_t * err_msg_len) {
    Instance * self_p = reinterpret_cast<Instance *>(self);
    std::string name_s(name, name_size);
