...
class MockPeerManager : public MockClass<MockPeerManager> {
    public:
        MockPeerManager(ReturnValue) {
            NAME_MOCK_MEM_FUN(MockPeerManager, constructor);
            NAME_MOCK_MEM_FUN(MockPeerManager, is_connected);
            NAME_MOCK_MEM_FUN(MockPeerManager, get_peer_ports);
            NAME_MOCK_MEM_FUN(MockPeerManager, get_peer_dims);
            NAME_MOCK_MEM_FUN(MockPeerManager, get_peer_locations);
            NAME_MOCK_MEM_FUN(MockPeerManager, get_peer_endpoints);
        }
